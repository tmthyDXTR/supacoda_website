...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (canvas) {
        ...
        const isIndexPage = currentPage === 'Home' || currentPage === 'Startseite';
        ...
        class Particle {
            constructor(index) {
                ...
                // Example: if baseOpacity=0.5, farPointOpacity=0.3, nearPointOpacity=1.0, layerRatio=0.5
                //   multiplier = 0.3 + 0.5 * (1.0 - 0.3) = 0.65
                //   depthOpacity = 0.5 * 0.65 = 0.325
                ...
                // Further particles get more offset (1 - layerRatio is higher when far)
            ...
            update(isIdle) {
                ...
                // Logo mode: uniform base size/opacity for all particles
                // Grid mode: varied depth size/opacity for 3D effect
        ...
        // Particles are created dynamically when logo points are loaded
        // (see generateLogoPoints function)
